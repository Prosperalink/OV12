...
class EnhancedAssetDownloader:
    def __init__(self):
        ...
        # Working public domain image URLs from Unsplash
    ...
    def run_download(self):
        ...
        # Define sections to process (images and videos)
        sections_to_process = [
            # Homepage - Images
            ("homepage", "hero_section", "images", 5),
            ("homepage", "solutions_matrix/digital_innovation", "images", 5),
            ("homepage", "solutions_matrix/creative_design", "images", 5),
            ("homepage", "solutions_matrix/content_creation", "images", 5),
            ("homepage", "solutions_matrix/technology_solutions", "images", 5),
            ("homepage", "solutions_matrix/strategic_consulting", "images", 5),
            ("homepage", "client_journey", "images", 5),
            ("homepage", "success_stories", "images", 5),
            ("homepage", "contact_section", "images", 5),
            
            # Homepage - Videos
            ("homepage", "hero_section", "videos", 3),
            ("homepage", "solutions_matrix/digital_innovation", "videos", 3),
            ("homepage", "solutions_matrix/creative_design", "videos", 3),
            ("homepage", "solutions_matrix/content_creation", "videos", 3),
            ("homepage", "solutions_matrix/technology_solutions", "videos", 3),
            ("homepage", "solutions_matrix/strategic_consulting", "videos", 3),
            ("homepage", "client_journey", "videos", 3),
            ("homepage", "success_stories", "videos", 3),
            ("homepage", "contact_section", "videos", 3),
            
            # About page - Images
            ("about", "hero", "images", 5),
            ("about", "mission", "images", 5),
            ("about", "values", "images", 5),
            ("about", "story", "images", 5),
            ("about", "cinematic_humanism", "images", 5),
            ("about", "team", "images", 5),
            ("about", "cta", "images", 5),
            ...
            ("about", "values", "videos", 3),
            ("about", "story", "videos", 3),
            ("about", "cinematic_humanism", "videos", 3),
            ("about", "team", "videos", 3),
            ("about", "cta", "videos", 3),
            
            # Contact page - Images
            ("contact", "hero", "images", 5),
            ("contact", "contact_info", "images", 5),
            ("contact", "contact_form", "images", 5),
            
            # Contact page - Videos
            ("contact", "hero", "videos", 3),
            ("contact", "contact_info", "videos", 3),
            ("contact", "contact_form", "videos", 3),
            
            # Services pages - Images
            ("services", "digital_innovation", "images", 5),
            ("services", "creative_design", "images", 5),
            ("services", "content_creation", "images", 5),
            ("services", "technology_solutions", "images", 5),
            ("services", "strategic_consulting", "images", 5),
            
            # Services pages - Videos
            ("services", "digital_innovation", "videos", 3),
            ("services", "creative_design", "videos", 3),
            ("services", "content_creation", "videos", 3),
            ("services", "technology_solutions", "videos", 3),
            ("services", "strategic_consulting", "videos", 3),
            
            # Blog - Images
            ("blog", "featured", "images", 5),
            ("blog", "articles", "images", 5),
            
            # Blog - Videos
            ("blog", "featured", "videos", 3),
            ("blog", "articles", "videos", 3),
            
            # Careers - Images
            ("careers", "hero", "images", 5),
            ("careers", "culture", "images", 5),
            ("careers", "opportunities", "images", 5),
            
            # Careers - Videos
            ("careers", "hero", "videos", 3),
            ("careers", "culture", "videos", 3),
            ("careers", "opportunities", "videos", 3),
            
            # Legal - Images
            ("legal", "privacy", "images", 5),
            ("legal", "terms", "images", 5),
            
            # Legal - Videos
            ("legal", "privacy", "videos", 3),
            ("legal", "terms", "videos", 3),
        ]
