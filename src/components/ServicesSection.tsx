...
import { Camera, Code, Globe, Palette, Users, Zap } from 'lucide-react';
...
const services = [
  ...
  },
  {
    ...
    title: 'UI/UX Design',
    description:
      'Cinematic user experiences that blend aesthetics with functionality.',
  ...
  },
  {
    ...
    description:
      'Professional video content that tells your story with cinematic quality.',
    features: [
      'Corporate Videos',
      'Product Demos',
  ...
  },
  {
    ...
    description:
      'Intelligent automation and AI-powered solutions for modern businesses.',
    features: [
      'Chatbots',
      'Content Generation',
      'Data Analysis',
  ...
  },
  {
    ...
    title: 'Consulting',
    description:
      'Strategic guidance to transform your digital presence and business growth.',
    features: [
      'Digital Strategy',
      'Technology Audit',
      'Growth Planning',
...
export default function ServicesSection() {
  return (
    <section
      id='services'
      className='py-20 bg-section-dark dark:bg-section-light'
    >
      <div className='max-w-7xl mx-auto px-4'>
        {/* Section Header */}
        <AnimationObserver animation='fadeIn' className='text-center mb-12'>
          <h2 className='text-4xl font-bold text-gray-900 dark:text-white mb-4'>
            Our Services
          </h2>
          <p className='text-xl text-gray-600 dark:text-gray-300'>
            We don&rsquo;t just build websites; we craft digital experiences
        ...
        {/* CTA Section */}
        <AnimationObserver animation='fadeIn' className='text-center mt-16'>
          <div className='bg-cinematic-blue rounded-3xl p-12 text-white'>
            ...
            <p className='text-xl mb-8 opacity-90'>
              ...
              comprehensive digital solutions and cinematic approach.
            </p>
