...
export const metadata: Metadata = {
  ...
  description: 'Building robust digital foundations that drive growth and competitive advantage. Custom solutions for Wedding & Events, Education & Learning, Small Business & Startups, Enterprise & Corporate, Creative & Artisan, and Tourism & Hospitality.',
};
...
const industries = [
  {
    ...
    features: ['Automated scheduling', 'Client portal', 'Payment integration', 'Portfolio showcase']
  },
  {
    ...
    features: ['Virtual classrooms', 'Progress tracking', 'Interactive quizzes', 'Parent communication']
  },
  {
    ...
    features: ['Online storefront', 'Inventory management', 'Customer database', 'Analytics dashboard']
  },
  {
    ...
    features: ['Scalable architecture', 'Security compliance', 'API integration', 'Performance monitoring']
  },
  {
    id: 'creative-artisan',
    ...
    features: ['Artist portfolios', 'Commission system', 'International shipping', 'Payment processing']
  },
  {
    ...
    features: ['Real-time availability', 'Guest portal', 'Revenue optimization', 'Customer insights']
  }
];
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            We craft cutting-edge digital solutions that bridge the gap between imagination and implementation, 
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Tailored digital solutions for every industry, designed to address your unique challenges and drive measurable results.
            </p>
          </div>
            ...
            {industries.map((industry, index) => (
              ...
              >
                ...
                <div className="space-y-4">
                  <h4 className="text-lg font-semibold text-blue-400">Solutions We Offer:</h4>
                  ...
                  <h4 className="text-lg font-semibold text-blue-400 mt-6">Key Features:</h4>
                  <ul className="space-y-2">
      ...
      <section className="py-20 bg-gradient-to-br from-blue-900 to-slate-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              A systematic approach to digital transformation that ensures success at every stage.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'We analyze your current digital infrastructure and identify opportunities for improvement.'
              },
              {
                step: '02',
                title: 'Strategy & Planning',
                description: 'Develop a comprehensive digital strategy tailored to your business goals and industry requirements.'
              },
              {
                step: '03',
                title: 'Development & Testing',
                description: 'Build robust, scalable solutions with rigorous testing to ensure reliability and performance.'
              },
              {
                step: '04',
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 via-blue-900/50 to-slate-900">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Let's discuss how our digital innovation solutions can drive growth and competitive advantage for your business.
          </p>
