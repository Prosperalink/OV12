        ...
        <div className='relative z-10 text-center text-white px-4 max-w-4xl mx-auto'>
          ...
          >
            ...
            <p className='text-lg md:text-xl mb-12 text-gray-300 max-w-3xl mx-auto leading-relaxed'>
              Experience a collaborative, transparent process that transforms
              your vision into a digital reality. We guide you through every
              step with expertise, creativity, and unwavering commitment to your
              success.
            </p>
          </motion.div>
        </div>
